...
devtools::install_local("/Users/jg/Desktop/PhD/DTU_project/satuRnRestore", force = TRUE, quiet = FALSE)
...
```{r}
Sys.time()
sumExp <- satuRnRestore::fitQB(object = sumExp,
                       parallel = TRUE,
...
```{r}
sumExp <- satuRnRestore::testDTU(object = sumExp, contrasts = L, plot=T, sort = T)
```
...
plots <- satuRnRestore::plotDTU(object = sumExp, contrast = "Contrast1", groups = list(group1,group2), coefficients = list(c(0,0,1),c(0,1,0)), summaryStat = "model", transcripts = c("ENSMUST00000081554","ENSMUST00000195963","ENSMUST00000132062"),genes = NULL,top.n = 6)
