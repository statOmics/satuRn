...
[![BioC status](http://www.bioconductor.org/shields/build/release/bioc/satuRn.svg)](https://bioconductor.org/checkResults/release/bioc-LATEST/satuRn)
[![R build status](https://github.com/jgilis/satuRn/workflows/R-CMD-check-bioc/badge.svg)](https://github.com/jgilis/satuRn/actions)
<!-- badges: end -->
...
Get the latest stable `R` release from [CRAN](http://cran.r-project.org/). Then install `satuRn` using from [Bioconductor](http://bioconductor.org/) the following code:
...
```{r example, eval = requireNamespace('satuRn')}
library("satuRn")
## basic example code
```
...
* The [documentation website](http://jgilis.github.io/satuRn) is automatically updated thanks to `r BiocStyle::CRANpkg('pkgdown')`.
